...
Public Class kartuantrian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Informasi_Rekam_Medis_Klinik_Medika.kartuantrian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_noantri() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedkartuantrian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As kartuantrian = New kartuantrian()
        rpt.Site = Me.Site
        Return rpt
    End Function
