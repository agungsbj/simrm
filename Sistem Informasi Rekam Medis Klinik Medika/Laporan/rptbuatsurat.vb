...
Public Class rptbuatsurat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Informasi_Rekam_Medis_Klinik_Medika.rptbuatsurat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptbuatsurat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptbuatsurat = New rptbuatsurat()
        rpt.Site = Me.Site
        Return rpt
    End Function
