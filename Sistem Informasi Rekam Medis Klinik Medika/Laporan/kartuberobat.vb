...
Public Class kartuberobat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Informasi_Rekam_Medis_Klinik_Medika.kartuberobat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idPasien() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedkartuberobat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As kartuberobat = New kartuberobat()
        rpt.Site = Me.Site
        Return rpt
    End Function
